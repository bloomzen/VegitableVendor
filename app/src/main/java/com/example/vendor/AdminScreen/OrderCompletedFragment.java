...
//    FirebaseRecyclerOptions<AdminHotelOrder> options;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            edt_search_pending = view.findViewById(R.id.edt_search_complete);
            recyclerViewPending = view.findViewById(R.id.recycler_complete);
            ...
            Toast.makeText(Vendor.getAppContext(), "Completed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getAllOrders() {
        ...
        try {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (snapshot.hasChildren()) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            mOrder.child(key).orderByChild("orderStatus").equalTo("Complete").addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.hasChildren()) {
                                        try {
            ...
            Toast.makeText(Vendor.getAppContext(), "Comp:" + e.getMessage(), Toast.LENGTH_SHORT).show();
        }


//
//        Query query = mOrder.orderByChild("orderStatus").equalTo("Complete");
